...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="id_penulis" class="form-label fw-semibold" style="font-size:13px;">
                    Penulis <span class="text-danger">*</span>
                </label>
                <select class="form-select @error('id_penulis') is-invalid @enderror"
                    id="id_penulis" name="id_penulis">
            ...
            <div class="mb-4">
                ...
                <div class="form-text" style="font-size:12px;">Format: JPG, JPEG, PNG. Maks 2 MB.</div>
                @error('gambar')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
